...
public class CompetitionViewController {
    ...
    public CompetitionViewController(CompetitionService competitionService, CompetitionEventService competitionEventService) {
    ...
    public String getCompetitionApply(@PathVariable Long id, Model model) {
        ...
        List<CompetitionEventListApplyDTO> competitionEventListApplyDTOList = new ArrayList<>();
        ...
        competitionEventList.forEach(competitionEvent -> {
            ...
            competitionEventListApplyDTOList.add(optionalCompetitionEvent.get().toCompetitionEventListApplyDTO());
        });

        model.addAttribute("competitionEventList", competitionEventListApplyDTOList);
